...
Plans.prototype.fetchDoctors = function (zipcode, insuranceIds) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var path = '/2014-09-12/insurances?' +
...
//   .fetchDoctors('95682', [])
//   .then(function (doctors) {
//     console.log(JSON.stringify([doctors[0]]));
//   })
//   .catch(function (err) {
//     console.log(err);
//   });
...
// plans
//   .fetchDoctors('76472', ['33602TX0460040'])
//   .then(function (doctors) {
//     console.log(JSON.stringify([doctors[0]]));
//   })
//   .catch(function (err) {
...
plans
  .fetch('76472')
  .then(function (data) {
    console.log(JSON.stringify([data.plans[0]]));
    console.log(JSON.stringify([data.doctors[0]]));
  })
  .catch(function (err) {
    console.log(err);
  });
