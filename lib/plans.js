...
Plans.prototype.fetchTradingPartners = function () {
  var self = this;

  console.log('Fetching trading partners');

  return new Promise(function (resolve, reject) {
    console.log('Making a request to Pokitdok trading partners endpoint');

    self.pokitdok.tradingPartners(function (err, res) {
      if (err) {
...
Plans.prototype.fetch = function (zipcode) {
  ...
  // // For testing
  // return new Promise(function (resolve, reject) {
  //   var data = JSON.parse(fs.readFileSync(__dirname + '/../data/plans.json'));
  //   data.tradingPartners = JSON.parse(fs.readFileSync(__dirname + '/../data/trading_partners.json'));
        ...
        self
          ...
          .then(function (doctors) {
            resolve({
              plans: plans,
              doctors: doctors,
              tradingPartners: JSON.parse(fs.readFileSync(__dirname + '/../data/trading_partners.json'))
            });
          })
          .catch(reject);
      })
...
//   .then(function (data) {
//     fs.writeFileSync('trading_partners.json', JSON.stringify(data));
//   })
//   .catch(function (err) {
//     console.error(err);
//   });
